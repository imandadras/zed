...
for i, UT in enumerate(UTs):
    drop.append(UT[300]-UT[0])
    retrieve.append(UT[-1]-UT[300])
plt.plot(activations_n, drop, label= "drop from column index 0 to 300")
plt.plot(activations_n, retrieve, label= "retrieve from column index 300 to 512")
